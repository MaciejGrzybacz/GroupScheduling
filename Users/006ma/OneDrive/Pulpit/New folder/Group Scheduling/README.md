...
Check out the :boxing_glove: [the competition scoreboard on wiki](https://gitlab.com/agh-courses/23/cp/inf-pzo-projects/proj-b/-/wikis/Scoreboard). :boxing_glove:
